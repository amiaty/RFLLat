SFLLat <- function(Y,J=min(15,floor(ncol(Y)/2)),alphaHuber=0.8,B="pc",lam1,lam2,
  ...
  ## Running FLLat.
  result <- .Call(C_LatHuber,Y,as.integer(J),as.double(alphaHuber),old.B,old.T,as.double(lam1),
